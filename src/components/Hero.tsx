...
export default function Hero() {
    ...
    return (
    <section className="relative flex items-center justify-center min-h-screen overflow-hidden bg-slate-100 bg-gradient-to-b dark:from-slate-700 dark:to-slate-900">
        ...
        <div data-aos="fade-in" data-aos-delay="700" className="relative max-w-[90%] xs:max-w-[100%] min-w-[70%]">
            <div className="flex flex-col items-start px-5 shadow-2xl py-7 md:px-10 md:py-14 dark:bg-slate-900 bg-slate-100">
                ...
                <TextReveal delay={1500} colors={{bg: "dark:bg-slate-50 bg-slate-800", text: "dark:text-slate-50 text-slate-800"}}>
                    <p className="text-lg font-semibold xs:text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl roboto-mono">
                        console.
                ...
                <TextReveal className="mt-4" delay={1700} colors={{bg: "bg-slate-300", text: "text-slate-300"}}>
                ...
                className="mt-8 space-x-4 roboto-mono">
